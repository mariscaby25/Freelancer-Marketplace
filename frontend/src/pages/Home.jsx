  ...
  return (
    <div className="home-page">
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(135deg, rgba(61,79,61,0.85), rgba(43,38,32,0.85)), url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1600&q=80')",
        }}
      >
      ...
      <section className="features">
        ...
        <div className="features-grid">
          <div className="feature-card">
            <div className="feature-icon"><i className="fa-solid fa-clipboard-list"></i></div>
            <h3>Post a Job</h3>
            <p>Clients can post job offers and review applications from qualified freelancers in minutes.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon"><i className="fa-solid fa-circle-check"></i></div>
